  ...
  <main class="main-container">
    <section class="banner-area">
      <div class="banner-container" style="position: relative;">
        ...
        <img src="@/assets/img/guides-banner-bg.webp" alt="guides and tips banner" class="banner-img">
      </div>
      ...
      <div class="category-item">
        ...
        <ul class="blog-list">
          <li class="blog-item" v-for="(blog,index) in blogs" :key="index">
            ...
            <nuxt-link :to="'/guides/' + blog.article_id" class="title-link"><h2 class="blog-title">{{blog.title}}</h2></nuxt-link>
            <nuxt-link :to="'/guides/' + blog.article_id" class="link">Read full Article</nuxt-link>
          </li>
        </ul>
...
export default {
  ...
  methods: {
    async getBlogs(page) {
      try {
        let results = await this.$axios.get(`https://api.toploansadviser.com/articles/all?website_id=96291576-b82f-47cd-ba81-28d9a33160a0&page=${page}&limit=${this.pageSize}`);
