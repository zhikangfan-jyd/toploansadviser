      ...
      <div class="banner-container">
        <div class="banner-content">
          ...
          <p class="desc">
            ...
            rates from up to 12 of the best personal loan lenders for in
            minutes. Plus, checking your rates is free and doesn't affect your
            credit score. Get your rate and see how much you can save today!
          </p>
          <a
            :href="mainLink"
            class="btn"
      ...
      <div class="footer-card-list">
        <div class="footer-card-item">
          ...
          <div class="footer-card-content">
            ...
            <div class="img-box">
              <img alt="toploansadviser" src="@/assets/img/q1.webp"/><img
              alt="toploansadviser"
              src="@/assets/img/q2.webp"
            />
              <img alt="toploansadviser" src="@/assets/img/q3.webp"/>
            </div>
          </div>
        </div>
      </div>
