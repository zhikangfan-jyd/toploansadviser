<template>
  <main class="main-container">
    <section class="banner-area">
      <div class="slogan">
        Make it easy to find affordable and responsible mortgages in the US.
      </div>
      <div class="banner-container">
        <h1 class="title">
          Compare Best Mortgage Lenders {{ updateTime().year }}
        </h1>
      ...
      <div class="product-container">
        <div class="product-container-top-box">
          <div class="disclosure">
            <span class="title" @click="showDisclosure"
              >Advertising Disclosure</span
            >
            <div :class="{ disclosure_content: true, show: isShow }">
    ...
    <section class="faq-area">
      <div class="faq-container">
        <h2 class="title">FAQ's About Mortgage Loans</h2>
        <div class="question-content">
          ...
          <ul>
            <li>
              <strong>Turn In Mortgage Application</strong> – The majority of
            ...
            <li>
              <strong>Begin Underwriting Process</strong> – Underwriters, using
          ...
          <ul>
            <li>
              <strong>Analyze Your Credit History</strong> – Look at your credit
              ...
              >. If there are any mistakes (that affect the score), address them
            ...
            <li>
              <strong>Review Offers</strong> – Any lender you applied with will
              give you a loan estimate that includes monthly payment, interest
              rate, closing costs and other important information.
            </li>
            <li>
              <strong>Pick Your Lender</strong> – Once you’ve reviewed each loan
              term,
              <a href="/mortgage-loan" rel="noopener noreferrer" target="_blank"
            ...
            <li>
              <strong>Close On The Home</strong> – At the closing, you’ll sign a
          ...
          <ul>
            <li>
              <strong>Interest Rate</strong> – Interest will vary by product and
              lender; make sure you’re comparison shopping to find the best
              possible deal
            </li>
            <li>
              <strong>Closing Costs</strong> – Closing costs will include the
          ...
          <ul>
            ...
            <li>
              <strong>USDA</strong> – The majority of lenders who do USDA loans
...
export default {
  head: seo({
    ...
    description:
      "Mortgage Loan is a type of loan that is secured by a home and provided by a mortgage lenderor a bank. There are many options for borrower with bad credit who can apply online instantly.",
    keywords:
      "mortgage loan,your mortgage online,mortgage,mortgage loans near me,mortgage loans for bad credit,mortgage rates",
