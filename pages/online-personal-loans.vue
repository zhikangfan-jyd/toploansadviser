       ...
       <section class="banner-area">
            <div class="banner-container">
                <div class="banner-content">
                    ...
                    <p class="desc">With our trusted partner, Eaglecashloan, you can compare prequalified rates from up to 12 of the best personal loan lenders for in minutes. Plus, checking your rates is free and doesn't affect your credit score. Get your rate and see how much you can save today!</p>
       ...
       <section class="how-it-work-area">
        ...
        <section class="info-area">
            <div class="info-container">
                ...
                <p class="small-text">Get personalized personal loan refi rates in 2 minutes</p>
            </div>
        </section>
