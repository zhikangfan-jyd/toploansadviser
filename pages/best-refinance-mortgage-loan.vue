        ...
        <div class="comments-container">
            ...
            <div class="comments-item second">
                ...
                <div class="comments-content">
                    ...
                    <p>Fast and easy. Got good rates and can start paying immediately</p>
                </div>
            </div>
            <div class="comments-item third">
                ...
                <div class="comments-content">
                    ...
                    <p>The process was simple and straightforward. There should be better notification that there was an error when we first entered our info for the application. We didn't know there was an error until we called for status as we hadn't heard in a couple days. I thought I'd be on hold for 30-60min. It was about 4min. Very helpful and patient and KNOWL-EDGEABLE person assisted. They walked me through all the steps (not many) and waited on the line while we made the corrections. I have been very happy! With multiple kids - this was my 6th year of applying for student loans and it was the Best experience by far. Website was straightforward after that first error. Write everything down as you pro-vide it: email, new password, website. You will need it later most likely!!</p>
                </div>
            </div>
            <div class="comments-item fourth">
                ...
                <div class="comments-content">
                    ...
                    <p>Easy well presented options Saved info so no need to represent</p>
                </div>
            </div>
            <div class="comments-item fifth">
                ...
                <div class="comments-content">
                    ...
                    <p>Credible made it easy and straightforward to see which lender was best for us. All under one roof. I applied, sent my documents and was approved quickly and at a good rate. Communication was great throughout process too. Would certainly use again and recommend highly. Thank you!</p>
                </div>
            </div>
        </div>
    </section>
