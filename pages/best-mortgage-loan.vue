      ...
      <div class="info-container">
        <div class="info-box">
          ...
          <div class="info-right">
            <p class="text">
              We help national people get their
              <span class="green">refinance mortgage loans</span>
            </p>
          </div>
        </div>
        ...
        <p class="small-text">
          Get personalized mortgage loan refi rates in 2 minutes
        </p>
      </div>
    </section>
...
@import "~/assets/scss/best-mortgage-loan.scss";
</style>
