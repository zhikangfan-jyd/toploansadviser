...
export default {
    ...
    methods: {
        handleOpen(index) {
            $('.fold-the-card-container .fold-the-card-item .fold-the-card-title-box .iconfont').eq(index).toggleClass('current');
            $('.fold-the-card-container .fold-the-card-item .fold-the-card-content').eq(index).slideToggle('fast');
        }
    }
}
</script>
